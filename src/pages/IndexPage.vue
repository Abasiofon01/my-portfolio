  ...
  >
    ...
    >
      <div>
        <TagLine />
        <h1
          class="tw-text-6xl md:tw-text-8xl tw-font-extrabold tw-text-neutral-300 tw-mb-16 tw-leading-tight tw-cursor-default"
        >
          Abasiofon Udonkang
        </h1>
      </div>
    ...
    <div class="tw-mt-36">
      ...
      >
        <div
          class="tw-grid tw-grid-cols-2 md:tw-grid-cols-4 tw-gap-2 lg:tw-gap-4 tw-mb-10"
        >
          <ThingCard
            v-for="tool in tools"
            :key="tool.id"
